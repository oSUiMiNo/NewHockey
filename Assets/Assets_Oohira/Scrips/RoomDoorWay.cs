    ...
    public override void OnJoinedRoom()
    {
        ...
        if (PhotonNetwork.IsMasterClient)
        {
            ...
            else
            {
                ...
                PhotonNetwork.Instantiate("Avatar1", new Vector3(0f, 10f, 90f), Quaternion.Euler(0, 180, 0));
            }
        ...
        else
        {
            ...
            else
            {
                ...
                PhotonNetwork.Instantiate("Avatar0", new Vector3(0f, 10f, -90f), Quaternion.identity);
            }
        }
    }
